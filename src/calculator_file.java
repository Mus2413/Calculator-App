 ...
 * @author Hp
 */
public class calculator_file extends javax.swing.JFrame {

    /**
     * Creates new form calculator_file
     */
    
    double num,ans;
    int calculation;
    public calculator_file() {
        initComponents();
 ...
 num=Double.parseDouble(jTextField1.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(calculator_file.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new calculator_file().setVisible(true);
            }
        });
    }
